...
class ConfigManager:
    ...
    def get_rate_limits(self, service: str = "default") -> Dict[str, Any]:
        ...
        return dict(self._rate_limits_data.get("rate_limits", {}).get("services", {}).get(service, {}))
        
    def get_api_key(self, key_name: str) -> str:
        """Retrieves an API key from the environment. Throws an error if empty or missing and critical."""
